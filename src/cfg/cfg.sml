 ...
 *
 * This is a first-order control-flow graph representation of ML Lite programs.
...
signature CFG =
  ...
  (* a ML Lite function application.  The type is the return type of the function,
   ...
   *)
    ...
    and function = FUN of {             (* a lifted function *)
  ...
  (* a program is a list of functions, where the first function is the entry for the
   * whole program.
   *)
